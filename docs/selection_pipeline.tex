...
\noindent
Alternatively, wget can also be used:

\begin{minted}[bgcolor=bg,frame=lines]{bash}
wget https://github.com/smilefreak/selectionTools/archive/master.zip
\end{minted}
...
By default it uses all the valid bases in the file that are one  of
either A,T,C,G,a,t,c or g.
