...
\section{Log Files}
\subsection{multi\_population}
The location of the log file for  \emph{multi\_population} defaults to "multipopulation.log" unless specified in the command line options. Contains all the logging information for the between population selection signature calculations.
\subsection{selection\_pipeline}
The location of the log file for \emph{selection\_pipeline} defaults to <chromosome + population + ".log"> unless specified in the command line options. Contains all the logging information for the within population selection signature calculations.
