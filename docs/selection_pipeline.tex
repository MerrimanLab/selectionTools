...
\begin{minted}[bgcolor=bg,frame=lines]{r}
library(rehh)
CEUihh=read.table("CEU/results/CEUchr2.ihh")
CEUihs=ihh2ihs(CEUihh)
par(mfrow=c(2,1))
#plot density
rect(136545410,-10,136594750,10,border="Blue") 
#plot iHS values for whole 10 megabase region. 
ihsplot(CEUihs$res.ihs,plot.pval=FALSE,main="CEU iHS",pch=".")
rect(136545410,-10,136594750,10,border="Blue") 
#plot iHS Pvalues
