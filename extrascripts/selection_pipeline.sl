...
srun python ~/.local/bin/multipop_selection_pipeline -p CEU_ids.txt -p YRI_ids.txt -i CEU_YRI_lactase.vcf --config-file ~/uoo00008/SelectionPipelineTestData/pipeline_test.cfg --a "--phased-vcf" -c 2
